...
public class MainWindow {
    ...
    protected void createShell() {
        ...
        this.shlChartDrawer.setText("GraphicCreator");
    ...
    protected void createChartField() {
        ...
        fd_composite.left = new FormAttachment(20);
    ...
    protected void createControls() {
        ...
        fd_table.right = new FormAttachment(20);
        fd_table.left = new FormAttachment(1);
        ...
        fd_btnNewButton.left = new FormAttachment(55, 70);
        fd_btnNewButton.right=new FormAttachment(75 );
        ...
        fd_spinner.left = new FormAttachment(20, 6);
        fd_spinner.right=new FormAttachment(35);
        ...
        fd_spinner_1.right = new FormAttachment(50 );
        fd_spinner_1.bottom = new FormAttachment(100, -6);
        fd_spinner_1.left = new FormAttachment(35);
